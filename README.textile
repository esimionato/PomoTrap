...
* "Mustache":http://github.com/defunkt/mustache => pure Ruby + HTML + JavaScript
* "Mustache TextMate Bundle":http://github.com/defunkt/Mustache.tmbundle
* "Rails3Template":http://github.com/dcrec1/rails3_template
